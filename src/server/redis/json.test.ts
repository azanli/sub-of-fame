...
describe('parseJson', () => {
  ...
  it('round-trips a LadderCachePage', () => {
    const page: LadderCachePage = {
      ...
      posts: [{ id: 't3_1', title: 'Hello', postUrl: 'https://www.reddit.com/r/test/comments/1/hello/', sourceSubredditName: 'test', hasBody: false, isNSFW: false, isSpoiler: false, commentCount: 42 }],
      fetchedAt: 1000,
    };
